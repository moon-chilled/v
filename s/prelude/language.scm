...
(defun utf8-encode (c)
  (cond
    ((< c #x80) (string (integer->char c)))
    ((< c #x800) (let ((b1 (logand c #b111111))
                      (b0 (ash c -6)))
                  (string (integer->char (logior b0 #b11000000))
                          (integer->char (logior b1 #b10000000)))))
    ((<= #xd800 c #xdfff) (error 'utf8-error "invalid surrogate codepoint ~a" c))
    ((< c #x10000) (let ((b2 (logand c #b111111))
                       (b1 (logand (ash c -6) #b111111))
                       (b0 (ash c -12)))
                   (string (integer->char (logior b0 #b11100000))
                           (integer->char (logior b1 #b10000000))
                           (integer->char (logior b2 #b10000000)))))
    ((< c #x110000) (let ((b3 (logand c #b111111))
